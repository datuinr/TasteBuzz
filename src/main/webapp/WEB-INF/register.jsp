...
<head>
	...
	<title>tastebuzz - Register</title>
...
<body>
	<div class="container">
		<b>Register</b>
		<p style="font-size:12px">Already a member? <a href="/login">Login</a></p>
		    <form:form method="POST" action="/register" modelAttribute="user">
		    <div class="formLine">
		        <form:input class="regInput" path="first" placeholder="first name"/>
		        <form:errors path="first" style="color:#44813e; font-size:12px;"/>
		    </div>
		    <div class="formLine">
		        <form:input class="regInput" path="last" placeholder="last name"/>		    
		        <form:errors path="last" style="color:#44813e; font-size:12px;"/>
		    </div>
			<div class="formLine">			
		        <form:input class="regInput" type="email" path="email" placeholder="email"/>
		        <form:errors path="email" style="color#44813e; font-size:12px;"/>
			</div>
			<div class="formLine">
		        <form:password class="regInput" path="password" placeholder="password"/>
		        <form:errors path="password" style="color:#44813e; font-size:12px;"/>
			</div>
		    <div class="formLine">
		        <form:password class="regInput" path="passwordConfirmation" placeholder="password confirmation"/>
		        <form:errors path="passwordConfirmation" style="color:#44813e; font-size:12px;"/>
		    </div>
